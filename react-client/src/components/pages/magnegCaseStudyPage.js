          ...
          <div className="main-content">
            <div className="indented-section">
              ...
              <ContentImage
                title=""
                content=""
                image={magnegPieChart}
              />
              </Col>
              <Col xs="12" m="3" lg="3" xl="3" className="subheader-content">
                <div calssName="subheader-text">Common Cloud Storage Features</div>
                <ul>
                ...
                <div calssName="subheader-text" style={{marginTop: "2em"}}>Most Important Features: </div>
                <ul>
              ...
              <Col xs="12" m="4" lg="4" xl="4" style={{marginTop: "4em"}}>
                <Content title=""
